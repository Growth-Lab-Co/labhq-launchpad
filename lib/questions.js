...
export const INTERVIEW_FIELDS = [
  ...
  { field: "pricing",       ask: "their prices - plans, packages or rates, actual numbers wherever possible, in their own words" },
  ...
  // Miia direct-customer, healthcareMode tenants only - see app/api/chat/
  // route.js's activeFields filtering. Kept out of the interview entirely
  // for everyone else rather than asked-then-ignored.
  { field: "practice_software", ask: "which practice management software you use day to day - Cliniko, Halaxy, something else, or none" },
  { field: "booking_link", ask: "do you use an online booking system like Cliniko or Halaxy? Paste the link patients use and {{assistant}} can send it to them" },
