...
export async function recordDeployment({
  ...
  const record = {
    ...
    demo: Boolean(demo),
    // Optional, not yet set by the real signup flow (which vertical a
    // business belongs to isn't captured at intake yet - see lib/bot.js's
    // health-guardrail comment). Lets a deployment opt into vertical-specific
    // hard guardrails, e.g. "allied-health" for the clinical-advice refusal.
